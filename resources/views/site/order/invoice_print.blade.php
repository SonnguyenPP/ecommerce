                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="width-80"></td>
                            <td class="footer-information currency_symbol">{{ formatNumber($order->tax_charge + $customFee['customTaxTotal'] ?? 0 + $customTax, optional($order->currency)->symbol) }}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="footer-information border-top currency_symbol">
                                {{ formatNumber($order->total + $customTax + $customFee['feeTotal'] + $customFee['customTaxTotal'], optional($order->currency)->symbol) }}
                            </td>
                        </tr>
                    </tbody>
                </table>
