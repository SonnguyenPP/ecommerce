                ...
                <div class="xl:px-30p px-5 border border-gray-2 pb-6">
                    ...
                    <div class="mt-8">
                        ...
                        <p class="roboto-medium font-medium text-gray-10 mb-1.5 break-all"> {{ $shippingAddress->address_1 }}
                            ...
                            {{ ucfirst($shippingAddress->city) }}</p>
                        <p class="roboto-medium font-medium text-gray-10 mb-1.5 break-all">{{ __('Postcode') }}: {{ $shippingAddress->zip }}</p>
                        <p class="roboto-medium font-medium text-gray-10 mb-1.5 break-all">{{ __('State') }}: {{ \Modules\GeoLocale\Entities\Division::getStateNameByCountryStateCode($shippingAddress->country, $shippingAddress->state) }}</p>
                        <p class="roboto-medium font-medium text-gray-10 mb-1.5 break-all">{{ __('Country') }}:{{ \Modules\GeoLocale\Entities\Country::getNameByCode($shippingAddress->country) }}</p>
                    </div>
                    @if(!empty($order->note))
                    <div>
                ...
                <div class="xl:px-30p px-5 border border-gray-2 pb-6">
                    ...
                    <div class="mt-8">
                        ...
                        <p class="roboto-medium font-medium text-gray-10 mb-1.5 break-all"> {{ $billingAddress->address_1 }}
                            ...
                            {{ ucfirst($billingAddress->city) }}</p>
                        <p class="roboto-medium font-medium text-gray-10 mb-1.5 break-all">{{ __('Postcode') }}: {{ $billingAddress->zip }}</p>
                        <p class="roboto-medium font-medium text-gray-10 mb-1.5 break-all">{{ __('State') }}: {{ \Modules\GeoLocale\Entities\Division::getStateNameByCountryStateCode($billingAddress->country, $billingAddress->state) }}</p>
                        <p class="roboto-medium font-medium text-gray-10 mb-1.5 break-all">{{ __('Country') }}:{{ \Modules\GeoLocale\Entities\Country::getNameByCode($billingAddress->country) }}</p>
                    </div>
            ...
            <table class="w-full bg-white overflow-hidden">
                    ...
                    @if(!empty($customFee))
                        ...
                        @foreach($feeData as $feeKey => $fee)
                            <tr class="focus-within:bg-gray-200 border border-gray-2 overflow-hidden">
                                <td class="dm-sans font-medium text-gray-12 px-6 py-18p">
                ...
                <tfoot>
                    ...
                    <tr class="focus-within:bg-gray-200 overflow-hidden border border-gray-2">
                        ...
                        <td class="dm-sans font-medium text-gray-12 px-6 py-18p">{{ formatNumber($order->tax_charge + $customTax + $customTaxTotal, optional($order->currency)->symbol) }}</td>
                    </tr>
                    @endif
                    @if ($couponOffer > 0)
                        <tr class="focus-within:bg-gray-200 overflow-hidden border border-gray-2">
                    ...
                    @if ($feeTotal > 0)
                        <tr class="focus-within:bg-gray-200 overflow-hidden border border-gray-2">
                            ...
                            @if (isActive('Shop'))
                                <td class="dm-sans font-medium text-gray-12 px-6 py-18p"></td>
                            @endif
                            <td class="dm-sans font-medium text-gray-12 px-6 py-18p">{{ __('Fees') }}:</td>
                            <td class="dm-sans font-medium text-gray-12 px-6 py-18p">{{ formatNumber($feeTotal, optional($order->currency)->symbol) }}</td>
                        </tr>
                    @endif
                    <tr class="focus-within:bg-gray-200 overflow-hidden border border-gray-2">
                        <td colspan="2" class="dm-sans font-medium text-gray-12 px-6 py-18p"></td>
                        ...
                        <td class="dm-sans font-medium text-gray-12 px-6 py-18p">{{ formatNumber($order->total + $customTax + $customTaxTotal + $feeTotal, optional($order->currency)->symbol) }}</td>
                    </tr>
                </tfoot>
            </table>
            <br>
