    ...
    <div class="3xl:mx-470p 2xl:mx-64 xl:mx-32 md:mx-20 mx-5 mb-70p 3xl:-mt-132p -mt-28 relative border border-gray-2 bg-white rounded-lg">
        ...
        <form method="post" action="{{ route('site.seller.signUpStore') }}"
            ...
            <div class="grid lg:grid-cols-2 grid-cols-1 lg:gap-3 gap-15p">
                ...
                <div class="w-full">
                    <label class="text-sm dm-sans font-medium capitalize text-gray-12">{{ __('State') . ' / ' . __('Province') }}
                    </label>
                    <select name="state" id="state" value="{{ old('state') }}" class="border-gray-2 mt-1.5 lg:mt-1p rounded-sm w-full h-46p roboto-medium pl-18p font-medium text-sm text-gray-10 form-control border focus:border-gray-12 addressSelect sl_common_bx">
