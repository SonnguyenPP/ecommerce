                    ...
                    <div class="grid grid-cols-2 lg:gap-3 gap-15p">
                        @if (preference('address_first_name_visible', 1))
                            <div class="lg:mb-3 mb-3.5">
                                <label class="text-sm dm-sans font-medium capitalize text-gray-12 {{ preference('address_first_name_required', 1) ? 'require-profile' : '' }}" for="first_name"> {{ __('First Name') }}</label>
                                <input class="border-gray-2 rounded-sm mt-1.5 lg:mt-1p w-full lg:h-46p h-10 roboto-medium font-medium text-sm text-gray-10 form-control border focus:border-gray-12 ltr:pl-18p rtl:pr-18p"type="text" id="first_name" name="first_name" value="{{ !empty(old('first_name')) ? old('first_name') : $address->first_name }}" {{ preference('address_first_name_required', 1) ? 'required' : '' }} oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                            </div>
                        @endif
                        @if (preference('address_last_name_visible', 1))
                            <div class="lg:mb-3 mb-3.5">
                                ...
                                <input class="border-gray-2 rounded-sm w-full mt-1.5 lg:mt-1p lg:h-46p h-10 roboto-medium ltr:pl-18p rtl:pr-18p font-medium text-sm text-gray-10 form-control focus:border-gray-12" id="last_name" name="last_name"
                                    ...
                                    type="text" {{ preference('address_last_name_required', 0) ? 'required' : '' }} oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                            </div>
                        @endif
                        @if (preference('address_company_name_visible', 1))
                            <div class="lg:mb-3 mb-3.5">
                                ...
                                <input class="border-gray-2 rounded-sm w-full mt-1.5 lg:mt-1p lg:h-46p h-10 roboto-medium ltr:pl-18p rtl:pr-18p font-medium text-sm text-gray-10 form-control focus:border-gray-12"type="text" name="company_name" id="company_name" value="{{ !empty(old('company_name')) ? old('company_name') : $address->company_name }}" {{ preference('address_company_name_required', 0) ? 'required' : '' }} oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                            </div>
                        @endif
                        @if (preference('address_phone_visible', 1))
                            <div class="order-2 lg:order-none lg:mb-3 mb-3.5  ">
                                <label class="text-sm dm-sans font-medium capitalize text-gray-12 {{ preference('address_phone_required', 1) ? 'require-profile' : '' }}" for="phone"> {{ __('Phone Number') }} </label>
                                <input class="border-gray-2 rounded-sm mt-1.5 lg:mt-1p w-full lg:h-46p h-10 roboto-medium ltr:pl-18p rtl:pr-18p font-medium text-sm text-gray-10 form-control border focus:border-gray-12" type="text" id="phone" name="phone" value="{{ !empty(old('phone')) ? old('phone') : $address->phone }}" {{ preference('address_phone_required', 1) ? 'required' : '' }}
                                    oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                            </div>
                        @endif
                        ...
                        @if (preference('address_street_address_1_visible', 1))
                            <div class="lg:mb-3 mb-3.5">
                                <label class="text-sm dm-sans font-medium capitalize text-gray-12 {{ preference('address_street_address_1_required', 1) ? 'require-profile' : '' }}" for="address_1"> {{ __('Street Address 1') }}</label>
                        ...
                        @if (preference('address_country_visible', 1))
                            <div class="w-full validSelect">
                                ...
                                <select name="country" id="country" class="border-gray-2 mt-1.5 lg:mt-1p rounded-sm w-full lg:h-46p h-10 roboto-medium ltr:pl-18p rtl:pr-18p font-medium text-sm text-gray-10 form-control border focus:border-gray-12 block addressSelect" {{ preference('address_country_required', 1) ? 'required' : '' }} oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                        ...
                        @if (preference('address_state_visible', 1))
                            <div class="w-full validSelect">
                                <label class="text-sm dm-sans font-medium capitalize text-gray-12 block {{ preference('address_state_required', 1) ? 'require-profile' : '' }}" for="state">{{ __('State') . ' / ' . __('Province') }} </label>
                                <select name="state" id="state" 
                                    class="border-gray-2 mt-1.5 lg:mt-1p rounded-sm w-full lg:h-46p h-10 roboto-medium ltr:pl-18p rtl:pr-18p font-medium text-sm text-gray-10 form-control border focus:border-gray-12 block addressSelect"
                        ...
                        @if (preference('address_city_visible', 1))
                            <div class="lg:mb-3 mb-3.5 validSelect">
                                <label class="text-sm dm-sans font-medium capitalize text-gray-12 mb-3p {{ preference('address_city_required', 1) ? 'require-profile' : '' }} block" for="city"> {{ __('City') }}</label>
                                <select name="city" id="city" class="border-gray-2 rounded-sm w-full lg:h-46p mt-1.5 lg:mt-1p h-10 roboto-medium ltr:pl-18p rtl:pr-18p font-medium text-sm text-gray-10 form-control border focus:border-gray-12 block addressSelect" {{ preference('address_city_required', 1) ? 'required' : '' }} oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
...
@section('js')
    <script>
        'use strict';
        let oldCountry = "{!! $address->country ?? 'null' !!}";
        let oldState = "{!! old('state') ?? 'null' !!}";
        let oldCity = "{!! $address->city ?? 'null' !!}";
    </script>
