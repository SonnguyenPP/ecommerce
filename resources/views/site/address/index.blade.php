                        ...
                        <div class="w-full h-full mb-6 px-5 border {{ $address->is_default == 1 ? 'border-yellow-1 bg-yellow-4 dark:border-gray-0 dark:bg-gray-3' : 'border' }} rounded ltr:lg:pl-30p rtl:lg:pr-30p">
                            ...
                            <div class="mt-8">
                                ...
                                <div class="roboto-medium font-medium text-base capitalize break-all mb-5 text-gray-10">
                                    ...
                                    @if (!empty(optional($address->country1)->name))
                    ...
                    <form action="{{ route('site.addressStore') }}" method="post" id="addressForm" onsubmit=" return formValidation()">
                            ...
                            <div class="grid grid-cols-2 lg:gap-3 gap-15p">
                                @if (preference('address_first_name_visible', 1))
                                    <div class="lg:mb-3 mb-3.5">
                                        <label class="text-sm dm-sans font-medium capitalize text-gray-12 {{ preference('address_first_name_required', 1) ? 'require-profile' : '' }}" for="first_name">
                                            {{ __('First Name') }}</label>
                                        <input class="border-gray-2 rounded-sm w-full mt-1.5 lg:mt-1p lg:h-46p h-10 roboto-medium font-medium text-sm text-gray-10 form-control border focus:border-gray-12  " type="text" id="first_name" name="first_name" type="text" value="{{ old('first_name') }}" {{ preference('address_first_name_required', 1) ? 'required' : '' }} oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                                    </div>
                                @endif
                                @if (preference('address_last_name_visible', 1))
                                    <div class="lg:mb-3 mb-3.5">
                                        <label class="text-sm dm-sans font-medium capitalize text-gray-12 {{ preference('address_last_name_required', 0) ? 'require-profile' : '' }}" for="last_name">{{ __('Last Name') }}</label>
                                        <input class="border-gray-2 rounded-sm w-full mt-1.5 lg:mt-1p lg:h-46p h-10 roboto-medium ltr:pl-18p rtl:pr-18p font-medium text-sm text-gray-10 form-control focus:border-gray-12" id="last_name" name="last_name" value="{{ old('last_name') }}" type="text" {{ preference('address_last_name_required', 0) ? 'required' : '' }} oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                                    </div>
                                @endif
                                @if (preference('address_company_name_visible', 1))
                                    <div class="lg:mb-3 mb-3.5">
                                        <label class=" text-sm dm-sans font-medium capitalize text-gray-12 {{ preference('address_company_name_required', 0) ? 'require-profile' : '' }}" for="company_name">{{ __('Company Name') }} </label>
                                        <input class="border-gray-2 rounded-sm w-full mt-1.5 lg:mt-1p lg:h-46p h-10 roboto-medium ltr:pl-18p rtl:pr-18p font-medium text-sm text-gray-10 form-control focus:border-gray-12"type="text" name="company_name" id="compnay_name" value="{{ old('company_name') }}" {{ preference('address_company_name_required', 0) ? 'required' : '' }} oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                                    </div>
                                @endif
                                @if (preference('address_phone_visible', 1))
                                    <div class="order-2 lg:order-none lg:mb-3 mb-3.5">
                                        <label class="text-sm dm-sans font-medium capitalize text-gray-12 {{ preference('address_phone_required', 1) ? 'require-profile' : '' }}" for="phone">{{ __('Phone Number') }}
                                        </label>
                                        <input class="border-gray-2 mt-1.5 lg:mt-1p rounded-sm w-full lg:h-46p h-10 roboto-medium ltr:pl-18p rtl:pr-18p font-medium text-sm text-gray-10 form-control border focus:border-gray-12" type="text" id="phone" name="phone" value="{{ old('phone') }}" {{ preference('address_phone_required', 1) ? 'required' : '' }} oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                                    </div>
                                @endif
                                @if (preference('address_email_address_visible', 1))
                                    <div class="order-first lg:order-none lg:mb-3 mb-3.5">
                                        <label class="text-sm dm-sans font-medium capitalize text-gray-12 {{ preference('address_email_address_required', 0) ? 'require-profile' : '' }}"for="email">{{ __('Email Address') }}</label>
                                        ...
                                        {{ preference('address_email_address_required', 0) ? 'required' : '' }} oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')"
                                            data-type-mismatch="{{ __('Enter a valid :x.', ['x' => strtolower(__('Email'))]) }}">
                                    </div>
                                @endif
                                @if (preference('address_street_address_1_visible', 1))
                                    <div class="lg:mb-3 mb-3.5">
                                        <label class="lg:block hidden mt-3p text-sm dm-sans font-medium capitalize text-gray-12 {{ preference('address_street_address_1_required', 1) ? 'require-profile' : '' }}"
                                            for="address_1">{{ __('Street Address 1') }} </label>
                                        <label class="lg:hidden block text-sm dm-sans font-medium capitalize text-gray-12 {{ preference('address_street_address_1_required', 1) ? 'require-profile' : '' }}" for="address_1">{{ __('Street Address') }} </label>
                                        <input id="address_1" name="address_1" type="text" value="{{ old('address_1') }}" class="border-gray-2 rounded-sm w-full mt-2 lg:mt-3p lg:h-46p h-10 roboto-medium ltr:pl-18p rtl:pr-18p font-medium text-sm text-gray-10 form-control focus:border-gray-12" {{ preference('address_street_address_1_required', 1) ? 'required' : '' }} oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                                    </div>
                                @endif
                                @if (preference('address_street_address_2_visible', 1))
                                    <div class="lg:block hidden lg:mb-3 mb-3.5">
                                        <label class="text-sm dm-sans font-medium capitalize text-gray-12 {{ preference('address_street_address_2_required', 0) ? 'require-profile' : '' }}" for="address_2">{{ __('Street Address 2') }}</label>
                                        <input id="address_2" name="address_2" type="text" value="{{ old('address_2') }}" class="border-gray-2 rounded-sm w-full mt-1.5 lg:mt-1p lg:h-46p h-10 roboto-medium ltr:pl-18p rtl:pr-18p font-medium text-sm text-gray-10 form-control focus:border-gray-12" {{ preference('address_street_address_2_required', 0) ? 'required' : '' }} oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                                    </div>
                                @endif
                                @if (preference('address_country_visible', 1))
                                    <div class="w-full validSelect">
                                        <label class="text-sm dm-sans font-medium capitalize text-gray-12 {{ preference('address_country_required', 1) ? 'require-profile' : '' }} block" for="country"> {{ __('Country') }} </label>
                                        <select name="country" id="country" class="border-gray-2 mt-1.5 lg:mt-1p rounded-sm w-full lg:h-46p h-10 roboto-medium ltr:pl-18p rtl:pr-18p font-medium text-sm text-gray-10 form-control border focus:border-gray-12 block required-field addressSelect" {{ preference('address_country_required', 1) ? 'required' : '' }} oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')"><option value="">{{ __('Select Country') }}</option>
                                        </select>
                                    </div>
                                @endif
                                @if (preference('address_state_visible', 1))
                                    <div class="w-full validSelect">
                                        <label class="text-sm dm-sans font-medium capitalize text-gray-12 {{ preference('address_state_required', 1) ? 'require-profile' : '' }} block" for="state">{{ __('State') . ' / ' . __('Province') }} </label>
                                        <select name="state" id="state" 
                                            class="border-gray-2 mt-1.5 lg:mt-1p rounded-sm w-full lg:h-46p h-10 roboto-medium ltr:pl-18p rtl:pr-18p font-medium text-sm text-gray-10 form-control border focus:border-gray-12 block required-field addressSelect"
                                            {{ preference('address_state_required', 1) ? 'required' : '' }} oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')"> 
                                ...
                                @if (preference('address_city_visible', 1))
                                    <div class="lg:mb-3 mb-3.5 validSelect">
                                        <label class="text-sm dm-sans font-medium capitalize mb-2.5 lg:mb-1 text-gray-12 {{ preference('address_city_required', 1) ? 'require-profile' : '' }} block" for="city">{{ __('City') }}</label>
                                        <select name="city" id="city" class="border-gray-2 rounded-sm w-full lg:h-46p mt-1.5 lg:mt-1p h-10 roboto-medium ltr:pl-18p rtl:pr-18p font-medium text-sm text-gray-10 form-control border focus:border-gray-12 block required-field addressSelect" {{ preference('address_city_required', 1) ? 'required' : '' }} oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')"><option value="">{{ __('Select City') }}</option>
                                        </select>
                                    </div>
                                @endif
                                @if (preference('address_zip_visible', 1))
                                    <div class="lg:mb-3 mb-3.5">
                                        <label class="lg:block hidden mt-3p text-sm dm-sans font-medium capitalize text-gray-12 {{ preference('address_zip_required', 0) ? 'require-profile' : '' }}" for="zip"> {{ __('Postcode') . ' / ' . __('ZIP') }} </label>
                                        <label class="lg:hidden block mt-2p text-sm dm-sans font-medium capitalize text-gray-12 {{ preference('address_zip_required', 0) ? 'require-profile' : '' }}" for="zip"> {{ __('Postcode') }} </label>
                                        <input id="zip" maxlength="10" name="zip" type="text" value="{{ old('zip') }}" class="border-gray-2 rounded-sm w-full h-46p mt-2 lg:mt-1p roboto-medium ltr:pl-18p rtl:pr-18p font-medium text-sm text-gray-10 form-control border focus:border-gray-12" {{ preference('address_zip_required', 0) ? 'required' : '' }} oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                                    </div>
                                @endif
                            </div>
                        </div>
                        @if (preference('address_type_of_place_visible', 1))
                            <div class="lg:mt-15p mt-18p">
                                <p class="lg:block hidden text-sm dm-sans font-medium capitalize text-gray-12">{{ __('Select the type of your place') }} {{ preference('address_type_of_place_required', 1) ? '*' : '' }}</p>
                                <p class="lg:hidden block text-sm dm-sans font-medium capitalize text-gray-12">{{ __('type of place') }} {{ preference('address_type_of_place_required', 1) ? '*' : '' }}</p>
