    ...
    <div class="row invoive-info">
        <div class="col-md-4 col-sm-6">
            ...
            <div class="row">
                <div class="col-md-10">
                    <h6>{{ __('Order Date') }}:</h6>
                    <input class="form-control inputFieldDesign" id="order_date" value='{{ $order->order_date }}' type="text">
                </div>
        ...
        <div class="col-md-4 col-sm-6 invoice-client-info">
            ...
            <div class="billing-information-container" id="billing_address">
                ...
                @if (preference('address_company_name_visible', 1))
                    <p class="m-0 m-t-10"> {{ __('Company Name') }}: <span> {{ $billingAddress->company_name }} </span> </p>
                @endif
                @if (preference('address_type_of_place_visible', 1))
                    <p class="m-0 m-t-10"> {{ __('Type of place') }}: <span> {{ $billingAddress->type_of_place }} </span> </p>
                @endif
                ...
                <p class="m-0 m-t-10"> {{ __('Address') }}: <span> 
                        ...
                        {{ !empty($billingAddress->city) ? ", " . ucfirst($billingAddress->city) : null }}
                        @endif
                    </span> 
                </p>
                @endif
        ...
        <div class="col-md-4 col-sm-6">
            ...
            <div class="billing-information-container" id="shipping_address">
                ...
                @endif
                @if (preference('address_email_address_visible', 1))
                    <p class="m-0 m-t-10"> {{ __('Phone') }}: <span><span> {{ $billingAddress->phone }} </span> {{ $shippingAddress->phone }} </a></span> </p>
                @endif
                @if (preference('address_company_name_visible', 1))
                    <p class="m-0 m-t-10"> {{ __('Company Name') }}: <span> {{ $shippingAddress->company_name }} </span> </p>
                @endif
                @if (preference('address_type_of_place_visible', 1))
                    <p class="m-0 m-t-10"> {{ __('Type of place') }}: <span> {{ $shippingAddress->type_of_place }} </span> </p>
                @endif
                 @if(preference('address_street_address_1_visible', 1) || preference('address_street_address_2_visible', 1) || preference('address_city_visible', 1))
                <p class="m-0 m-t-10"> {{ __('Address') }}: 
                    <span> 
                        ...
                        @endif
                        @if(preference('address_city_visible', 1))
                        {{ !empty($shippingAddress->city) ? ", " . ucfirst($shippingAddress->city) : null }}
                        @endif
                    </span> 
                </p>
                 @endif
