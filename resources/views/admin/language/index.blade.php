                                        ...
                                        <tbody>
                                            @foreach ($languageList as $language)
                                                <tr>
                                                    ...
                                                    <td class="align-middle">{{ $language->short_name }}</td>
                                                    ...
                                                    <td class="align-middle">
                                                        @php
                                                            $color = $language->status == 'Active' ? 'badge-mv-success' : 'badge-mv-danger';
                                                        @endphp
                                                        <span
                                                            class="badge badge-mv-primary f-12 f-w-600 {{ $color }}">{{ $language->status }}</span>
                                                    </td>
                                                    @if (array_intersect(
                                                            [
                                                                'App\Http\Controllers\LanguageController@translation',
                                                        ...
                                                        <td class="align-middle">
                                                            @if (in_array('App\Http\Controllers\LanguageController@translation', $prms))
                                                                <a title="{{ __('Import language') }}"
                                                                    href="{{ route('language.import', $language->id) }}"
                                                                    class="action-icon"><span
                                                                        class="feather icon-download"></span></a> &nbsp;
                                                            @endif
                                                            ...
                                                            @if (in_array('App\Http\Controllers\LanguageController@edit', $prms))
                                                                <a title="{{ __('Edit language') }}"
                                                                    ...
                                                                    class="action-icon edit_language"
                                                            ...
                                                            @if (in_array('App\Http\Controllers\LanguageController@delete', $prms) &&
                                                                ...
                                                                <form method="POST"
                                                                    ...
                                                                    <input type="hidden" name="id"
                                                                        value="{{ $language->id }}">
                                                                    <a title="{{ __('Delete') }}"
                                                                        class="action-icon confirm-delete"
