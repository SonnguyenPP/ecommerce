                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="width-80"></td>
                            <td class="footer-information currency_symbol">{{ formatNumber($tax + $customTax + $customFee['customTaxTotal'], optional($order->currency)->symbol) }}
                            </td>
                        </tr>
                        @if(isset($customFee['feeTotal']) && $customFee['feeTotal']) > 0)
                        <tr>
                            <td class="width-380"> </td>
                            <td class="footer-information">{{ __('Fees') }} :</td>
                            <td class="width-80"></td>
                            <td class="footer-information currency_symbol">{{ formatNumber($customFee['feeTotal'], optional($order->currency)->symbol) }}
                            </td>
                        </tr>
                        @endif
                        @if ($discountAmount > 0)
                        ...
                        <tr>
                            ...
                            <td class="footer-information border-top currency_symbol">
                                {{ formatNumber(($subTotal + $shippingCharge + $tax - $discountAmount + $customTax + $customFee['feeTotal'] + $customFee['customTaxTotal']), optional($order->currency)->symbol) }}
                            </td>
                        </tr>
                    </tbody>
                </table>
