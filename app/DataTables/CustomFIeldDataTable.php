    ...
    public function ajax(): JsonResponse
    {
        ...
        return datatables()
            ...
            ->editColumn('name', function ($customField) {
                ...
                $str = '';
                if ($this->hasPermission(['App\Http\Controllers\CustomFieldController@edit'])) {
                    $str .= '<a data-bs-toggle="tooltip" title="' . __('Edit') . '" href="' . route('custom_fields.edit', ['id' => $customField->id]) . '" class="action-icon"><i class="feather icon-edit-1 neg-transition-scale-svg"></i></a>&nbsp;';
                }
                if ($this->hasPermission(['App\Http\Controllers\CustomFieldController@destroy'])) {
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->addColumn([
                ...
                'visible' => $this->hasPermission(['App\Http\Controllers\CustomFieldController@edit', 'App\Http\Controllers\CustomFieldController@destroy']),
