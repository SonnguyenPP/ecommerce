...
class OrderSettingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        foreach ($request->only('order_prefix', 'order_refund', 'guest_order', 'bulk_pay_count', 'disable_bulk_payment', 'bulk_payment_user_role', 'order_product_edit', 'order_address_edit', 'order_notify_mail_address') as $key => $value) {
