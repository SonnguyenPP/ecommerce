...
Route::group(['middleware' => ['auth', 'locale', 'permission']], function () {
    ...
    Route::post('orders/customize', 'VendorOrderController@customize')->name('vendor.order.customize');
    Route::post('user-address', 'VendorOrderController@userAddress')->name('vendor.order.user.address');
