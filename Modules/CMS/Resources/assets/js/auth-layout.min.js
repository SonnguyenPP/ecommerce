"use strict";$(".auth-template-action-btn").on("click",function(){$(this).toggleClass("text-dark"),$(this).closest(".single-auth-template").find(".settings").toggleClass("active")}),$(".imgbgchk").on("change",function(){let a="";authSettings[$(this).val()].required.includes("title")&&(a+=`<div class="form-group row">
            <label for="title"
        ...
        </div>`),authSettings[$(this).val()].required.includes("description")&&(a+=`<div class="form-group row">
        ...
        </div>`),authSettings[$(this).val()].required.includes("file")&&(a+=`<div class="form-group row">
        ...
        </div>`),$("#extra_content").hide(),$("#extra_content").html(a),$("#extra_content").fadeIn(400),$(".preview-button").attr("href",url+"/auth/login?template="+$(this).val())});
