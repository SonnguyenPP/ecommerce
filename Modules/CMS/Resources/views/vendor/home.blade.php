                ...
                <div class="card-block pt-2 px-2">
                    <div class="col-sm-12 row m-0 p-0">
                        @forelse ($pages as $page)
                            <div class="col-12 col-xl-4 col-md-6 col-sm-6 mb-3">
                                <div class="card h-100 box-shadow-unset border">
                                    <div class="card-body pb-0">
                                        ...
                                        @endif
                                        <p class="card-text">
                                        <dl class="dl-horizontal row pb-0">
                                    ...
                                    <div class="card-footer header-btns-lg border-unset">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input type="text" required class="form-control inputFieldDesign" id="pageName" name="name" placeholder="{{ __('Name') }}">
                                    <select name="lang">
                                        @foreach ($languages as $shortName => $name)
                                            <option @selected($shortName == request()->input('lang', 'en')) value="{{ $shortName }}">
                                                {{ $name }}
                                            </option>
                                        @endforeach
                                    </select>
...
@section('js')
    ...
    <script src="{{ asset('Modules/CMS/Resources/assets/js/app.js') }}"></script>
