...
class MenuItemsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        addMenuItem('admin', '{"en":"Authentication Layout","bn":"প্রমাণীকরণ বিন্যাস","fr":"Disposition d\'authentification","zh":"认证布局","ar":"تخطيط المصادقة","be":"Макет аўтэнтыфікацыі","bg":"Оформление за удостоверяване на самоличността","ca":"Disseny d\'autenticació","et":"Autentimise paigutus","nl":"Authenticatie-indeling"}', [
