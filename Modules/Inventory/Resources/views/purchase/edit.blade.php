                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <input type="hidden" name="vendor_id" id="vendor_id" value="{{ $purchaseDetails->vendor_id }}">
                                    <div class="col-md-8">
                                        <select class="form-control" readonly="true">
                                            <option value="{{ $purchaseDetails->vendor_id }}" selected>{{ $purchaseDetails->vendor->name }}</option>
                                        </select>
                            ...
                            <div class="col-sm-12">
                                <table class="table" id="product-table">
                                    ...
                                    <tr class="itemRow rowNo-{{ $key }}" id="productId-{{ $detail->product_id }}"  data-row-no="{{ $key }}">
                                        ...
                                        <td class="productQty">
                                            <input name="product_qty[]" id="product_qty_{{ $key }}" class="inputQty form-control text-center positive-float-number" type="text" value="{{ $detail->quantity }}" data-rowId = {{ $key }}>
                                        </td>
                                        <td class="productCost">
                                            <input id="product_cost_{{ $key }}" name="product_cost[]" class="inputCost form-control text-center positive-float-number" type="text"  value="{{ $detail->amount }}">
                                        </td>

                                        <td class="productTax">
                                            <input  id="product_tax_{{ $key }}" type="text" class="inputTax form-control text-center positive-float-number" name="product_tax[]" value="{{ $detail->tax_charge }}">
                                        </td>
                                        @php
                            ...
                            <div class="card-body">
                                <div id="cost_management">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-form-label col-md-6" id="cost_management_shipping">{{ $purchaseDetails->shipping_charge }}</label>
                                    </div>
                                    @if (isset($adjustments['name']))
                                        @foreach($adjustments['name'] as $key => $adjust)
...
@section('js')
    ...
    <script src="{{ asset('Modules/Inventory/Resources/assets/js/purchase.min.js') }}"></script>
@endsection
