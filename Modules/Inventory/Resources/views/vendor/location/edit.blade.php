...
@section('page_title', __('Edit :x', ['x' => __('Location')]))
    ...
    <div class="col-sm-12" id="location-add-container">
        <div class="card">
            <div class="card-header">
                <h5> <a href="{{ route('vendor.location.index') }}">{{ __('Locations') }} </a>
                    >>{{ __('Edit :x', ['x' => __('Location')]) }}</h5>
            </div>
            <div class="card-block table-border-style">
                <div class="row form-tabs">
                    <form action="{{ route('vendor.location.update', $location->id) }}" method="post"
                        ...
                        <div class="col-sm-12 tab-content" id="myTabContent">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" placeholder="{{ __('Name') }}"
                                                       ...
                                                       value="{{ $location->name }}" required maxlength="80"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" placeholder="{{ __('Slug') }}"
                                                       ...
                                                       value="{{ $location->slug }}" required maxlength="80"
                                                       oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="email" class="form-control inputFieldDesign bg-white"
                                                       id="email" name="email" value="{{ $location->email }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control select2-hide-search inputFieldDesign"
                                                    ...
                                                    <option value="0"
                                                        {{ $location->is_default == '0' ? 'selected' : '' }}>
                                                        {{ __('No') }}</option>
                                                    <option value="1"
                                                        {{ $location->is_default == '1' ? 'selected' : '' }}>
                                                        {{ __('Yes') }}</option>
                                                </select>
                                            </div>
                                        </div>
                            ...
                            <div class="col-sm-10 px-0 mt-3 mt-md-0">
                                <a href="{{ route('vendor.location.index') }}"
...
@section('js')
    <script>
        'use strict';
        let oldCountry = "{!! $location->country ?? 'null' !!}";
        let oldState = "{!! $location->state ?? 'null' !!}";
        let oldCity = "{!! $location->city ?? 'null' !!}";
        let url = "{{ URL::to('/') }}";
    </script>
