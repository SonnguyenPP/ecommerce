    ...
    public function ajax(): JsonResponse
    {
        ...
        return datatables()
            ...
            ->editColumn('name', function ($locations) {
                ...
                if ($this->hasPermission(['Modules\Inventory\Http\Controllers\Vendor\LocationController@edit'])) {
                    $str = '<a title="' . __('Edit') . '" href="' . route('vendor.location.edit', ['id' => $locations->id]) . '" class="action-icon"><i class="feather icon-edit-1 neg-transition-scale-svg "></i></a>&nbsp;';
                }

                if ($this->hasPermission(['Modules\Inventory\Http\Controllers\Vendor\LocationController@destroy'])) {
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->addColumn(['data' => 'action', 'name' => 'action', 'title' => '', 'width' => '12%',
                ...
                'visible' => $this->hasPermission(['Modules\Inventory\Http\Controllers\Vendor\LocationController@edit', 'Modules\Inventory\Http\Controllers\Vendor\LocationController@destroy']),
