    ...
    public function ajax(): JsonResponse
    {
        ...
        return datatables()
            ...
            ->editColumn('name', function ($suppliers) {
                ...
                if ($this->hasPermission(['Modules\Inventory\Http\Controllers\Vendor\SupplierController@edit'])) {
                    $str .= '<a title="' . __('Edit') . '" href="' . route('vendor.supplier.edit', ['id' => $suppliers->id]) . '" class="action-icon"><i class="feather icon-edit-1 neg-transition-scale-svg "></i></a>&nbsp;';
                }

                if ($this->hasPermission(['Modules\Inventory\Http\Controllers\Vendor\SupplierController@destroy'])) {
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->addColumn(['data' => 'action', 'name' => 'action', 'title' => '', 'width' => '12%',
                ...
                'visible' => $this->hasPermission(['Modules\Inventory\Http\Controllers\Vendor\SupplierController@edit', 'Modules\Inventory\Http\Controllers\Vendor\SupplierController@destroy']),
